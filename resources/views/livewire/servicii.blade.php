<div class="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
    <!-- Hero Section -->
    <div class="relative">
        <div class="absolute inset-0 bg-fixed bg-center bg-cover" style="background-image: url('assets/servicii.webp')">
        </div>
        <div class="absolute inset-0 bg-gradient-to-b from-black/80 via-black/70 to-gray-900"></div>
        <div class="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-4 py-16">
            <span class="px-4 py-1.5 text-sm font-medium text-blue-400 bg-blue-500/10 rounded-full mb-6">
    ...
    <!-- Services Section -->
    <div id="servicii" class="relative py-20">
        <div
        ...
        <div class="container px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div
                    ...
                    <div
                        class="flex items-center justify-center w-12 h-12 mb-4 text-green-500 rounded-lg bg-green-500/10">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div
                        class="flex items-center justify-center w-12 h-12 mb-4 text-yellow-500 rounded-lg bg-yellow-500/10">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
