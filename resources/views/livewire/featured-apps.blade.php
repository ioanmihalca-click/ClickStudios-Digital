    ...
    <div class="container px-4 mx-auto">
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('portfolio') }}" 
              wire:navigate class="inline-flex items-center justify-center px-8 py-3 text-base font-medium text-white transition-all duration-300 rounded-lg bg-emerald-600 hover:bg-emerald-700 min-w-[200px]">
                See All Apps
