 <div>
     <section class="bg-white">
         ...
         <div id="portofoliu" class="container px-2 mx-auto mt-8">


             <h2 class="mb-8 text-xl font-bold text-center text-black uppercase font-roboto-condensed md:text-2xl">
                 Aplicatii Web si Site-uri</h2>
             ...
             <h2 class="my-12 text-xl font-bold text-center text-black uppercase font-roboto-condensed md:text-2xl">
                 Multimedia</h2>
             <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                 ...
                 <div x-data="{ open: false }"
                     class="overflow-hidden transition-all duration-300 bg-white shadow-lg rounded-xl hover:shadow-xl">
                     <div class="relative group">
                         <img src="/assets/podcastmorosenesc.jpg" alt="Productie Podcast Morosenesc cu Ioana Mihalca"
                             class="object-cover w-full h-full transition duration-300 ease-in-out group-hover:opacity-75">
                         <div
                             class="absolute inset-0 flex items-end justify-start p-6 transition-opacity duration-300 opacity-0 bg-gradient-to-b from-transparent to-black group-hover:opacity-100">
                             <h3
     ...
     <div class="container mx-auto my-8">
         <h2 class="mb-8 text-xl font-bold text-center text-black uppercase font-roboto-condensed md:text-2xl">Reclame
             video scurte</h2>

         <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
             <div class="mx-auto fb-video" data-href="https://www.facebook.com/reel/998070601980625" data-width="300"
