<div class="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900">
    ...
    <div class="container relative z-10 px-4 py-24 mx-auto">
        ...
        <div x-data="{ selectedItem: null, hoverItem: null, mouseX: 0, mouseY: 0 }" @mousemove="mouseX = $event.clientX; mouseY = $event.clientY"
            ...
            <!-- SportClubPro -->
            <div @click="selectedItem = 'sportclubpro'" @mouseenter="hoverItem = 'sportclubpro'"
            ...
            <!-- AIpofta -->
            <div @click="selectedItem = 'aipofta'" @mouseenter="hoverItem = 'aipofta'" @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
                        class="absolute inset-0 transition-opacity duration-500 opacity-0 bg-gradient-to-br from-emerald-500/0 via-transparent to-emerald-500/0 group-hover:opacity-20">
            ...
            <!-- Povestitorul Magic -->
            <div @click="selectedItem = 'povestitorul-magic'" @mouseenter="hoverItem = 'povestitorul-magic'"
                @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
            ...
            <!-- Click Music App -->
            <div @click="selectedItem = 'click-music'" @mouseenter="hoverItem = 'click-music'"
                @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
            ...
            <!-- InstaCapture -->
            <div @click="selectedItem = 'instacapture'" @mouseenter="hoverItem = 'instacapture'"
                @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
            ...
            <!-- Snow 'n' Stuff -->
            <div @click="selectedItem = 'snow-n-stuff'" @mouseenter="hoverItem = 'snow-n-stuff'"
                @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
            ...
            <!-- CS Victoria MM -->
            <div @click="selectedItem = 'cs-victoria-mm'" @mouseenter="hoverItem = 'cs-victoria-mm'"
                @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
            ...
            <!-- Ioana Mihalca -->
            <div @click="selectedItem = 'ioana-mihalca'" @mouseenter="hoverItem = 'ioana-mihalca'"
                @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
            ...
            <!-- Truland -->
            <div @click="selectedItem = 'truland'" @mouseenter="hoverItem = 'truland'" @mouseleave="hoverItem = null"
                class="relative overflow-hidden transition-all duration-500 border cursor-pointer group rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:border-emerald-500/50">
                <div class="flex flex-col h-full p-6">
                    <div
                        class="absolute inset-0 transition-opacity duration-500 opacity-0 bg-gradient-to-br from-emerald-500/0 via-transparent to-emerald-500/0 group-hover:opacity-20">
            ...
            {{-- <div x-show="hoverItem" :style="{ left: `${mouseX + 20}px`, top: `${mouseY - 200}px` }"
                ...
                <div class="relative overflow-hidden shadow-2xl rounded-xl">
                    <img :src="getImagePath(hoverItem)" :alt="hoverItem + ' preview'"
            ...
            <div x-cloak x-show="selectedItem !== null" class="fixed inset-0 z-[60] overflow-hidden"
                ...
                <div x-show="selectedItem !== null" x-transition:enter="transform transition ease-in-out duration-500"
                    ...
                    <div class="p-6 overflow-y-auto max-h-[calc(100vh-5rem)]">
                        ...
                        <!-- SportClubPro Details -->
                        <div x-show="selectedItem === 'sportclubpro'" class="space-y-6">
                            <h2 class="mb-4 text-3xl font-bold text-white">SportClubPro</h2>
                            <div class="relative overflow-hidden rounded-xl">
                                <img src="/assets/portofoliu/sportclubpro.jpg" alt="Platforma SportClubPro"
                                    class="w-full h-auto transition-transform duration-300 transform rounded-xl hover:scale-105">
                            </div>
                            <p class="text-gray-300">
                                SportClubPro este o platformă gratuită și eficientă pentru managementul cluburilor
                                sportive, oferind o soluție modernă pentru administrarea activităților zilnice.
                            </p>
                            <div class="space-y-2">
                                ...
                                <ul class="space-y-2 text-gray-300">
                                    ...
                                    <li class="flex items-center gap-2">
                                        ...
                                        Organizare evenimente și competiții
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <svg class="w-5 h-5 text-emerald-500" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                            ...
                            <a href="https://sportclubpro.ro" target="_blank" rel="noopener noreferrer"
                        ...
                        <div x-show="selectedItem === 'aipofta'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                AIpofta este primul generator de rețete personalizate din România bazat pe inteligență
                                artificială
                            </p>
                            <div class="space-y-2">
                        ...
                        <div x-show="selectedItem === 'povestitorul-magic'" class="space-y-6">
                            ...
                            <div class="relative overflow-hidden rounded-xl">
                                <img src="/assets/portofoliu/povestitorul-magic.webp"
                                    alt="Platforma Povestitorul Magic"
                                    class="w-full h-auto transition-transform duration-300 transform rounded-xl hover:scale-105">
                            </div>
                            <p class="text-gray-300">
                                Povestitorul Magic este o platformă inovatoare care folosește inteligența artificială
                                pentru a crea povești personalizate cu ilustrații captivante pentru copii. Această
                                aplicație unică îmbină tehnologia modernă cu creativitatea pentru a oferi experiențe de
                                lectură interactive și memorabile.
                            </p>
                            <div class="space-y-2">
                                <h3 class="text-lg font-semibold text-emerald-400">Tehnologii utilizate</h3>
                                <ul class="space-y-2 text-gray-300">
                        ...
                        <div x-show="selectedItem === 'click-music'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                Clickmusic.ro este rezultatul eforturilor noastre constante de a crea soluții digitale
                                de înaltă calitate, îmbunătățind experiența utilizatorilor în domeniul streaming-ului
                                muzical.
                            </p>
                            <div class="space-y-2">
                        ...
                        <div x-show="selectedItem === 'instacapture'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                InstaCapture.ro este o aplicație web inovatoare dezvoltată de agenția noastră pentru
                                firma de fotografie profesională InstaCapture din Cluj-Napoca.
                            </p>
                            <div class="space-y-2">
                                <h3 class="text-lg font-semibold text-emerald-400">Caracteristici principale</h3>
                                <ul class="space-y-2 text-gray-300">
                        ...
                        <div x-show="selectedItem === 'snow-n-stuff'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                Snow 'n' Stuff este un label muzical internațional de top, specializat în genurile Tech
                                House, Deep House, House și Techno.
                            </p>
                            <div class="space-y-2">
                        ...
                        <div x-show="selectedItem === 'cs-victoria-mm'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                ...
                                fascinantă în definirea și exprimarea identității acestuia în mediul online și offline.
                            </p>
                            <div class="space-y-2">
                        ...
                        <div x-show="selectedItem === 'ioana-mihalca'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                Am creat un site de prezentare și blog pentru Ioana Mihalca, jurnalistă și moderatoare
                                de emisiuni și evenimente.
                            </p>
                            <div class="space-y-2">
                        ...
                        <div x-show="selectedItem === 'truland'" class="space-y-6">
                            ...
                            <p class="text-gray-300">
                                Truland este un magazin online specializat în încălțăminte de calitate, oferind o gamă
                                variată de pantofi, mocasini, ghete și sandale pentru femei.
                            </p>
                            <div class="space-y-2">
    ...
    <div class="grid max-w-5xl grid-cols-1 gap-8 p-4 mx-auto md:grid-cols-2">
        ...
        <!-- Podcast Morosenesc -->
        <a href="https://www.youtube.com/@IoanaMihalca" target="_blank" rel="noopener noreferrer"
            ...
            <div class="w-full h-[200px] overflow-hidden rounded-t-xl">
                <img src="/assets/podcast-morosenesc.webp" alt="Productie Podcast Morosenesc"
            ...
            <div class="flex flex-col flex-1 p-6">
                ...
                <p class="mb-4 text-gray-300 transition-colors duration-300 group-hover:text-white">
                    "Podcast Morosenesc cu Ioana Mihalca" este un proiect de succes dedicat explorării povestirilor
                    autentice și discuțiilor captivante.
                </p>
                <div class="mt-auto space-y-4">
                    ...
                    <span
                        class="inline-flex items-center px-4 py-2 text-sm text-white transition-colors duration-300 rounded-lg bg-emerald-600 group-hover:bg-emerald-700">
        ...
        <!-- Click Music YouTube -->
        <a href="https://www.youtube.com/@clickmusicromania" target="_blank" rel="noopener noreferrer"
            class="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-emerald-500/50 transition-all duration-500 flex flex-col h-[500px] cursor-pointer">
            <div class="w-full h-[200px] overflow-hidden rounded-t-xl">
                <img src="/assets/clickmusicyt.jpg" alt="Click Music YouTube"
                    class="object-cover w-full h-full transition-transform duration-500 transform group-hover:scale-105">
            </div>
            <div class="flex flex-col flex-1 p-6">
                <div
                ...
                <p class="mb-4 text-gray-300 transition-colors duration-300 group-hover:text-white">
                    Click Music Romania reprezintă o parte importantă a activității noastre în domeniul producției
                    muzicale și al conținutului video, cu peste 50 de milioane de vizualizări.
                </p>
                <div class="mt-auto space-y-4">
                    <div class="flex flex-wrap gap-2">
                        <span
