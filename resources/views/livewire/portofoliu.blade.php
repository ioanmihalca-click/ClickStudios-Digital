 <div>
     ...
     <div class="relative h-screen bg-fixed bg-center bg-cover shadow-2xl"
         ...
         <div class="relative z-10 flex flex-col items-center justify-center h-full">
             ...
             <div class="max-w-2xl mx-auto">
                 <p
                     class="p-2 px-2 mb-16 text-lg tracking-wide text-center text-white bg-black bg-opacity-15 font-volkov">
                     "Singurul mod de a
             ...
             <div class="grid grid-cols-1 gap-4 px-2">
                 <a href="#aplicatii-web"
                     class="px-10 py-2 text-xs tracking-widest text-white uppercase transition-all duration-300 border border-white bg-emerald-600 scroll-link hover:bg-white hover:text-black font-roboto-condensed hover:border-transparent">Aplicatii
                     Web</a>
         ...
         <div class="container max-w-5xl px-2 mx-auto">
             ...
             <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3" x-data="{ hover: null }">
                 ...
                 <div @click="selectedItem = 'povestitorul-magic'"
                     @mouseenter="hoverItem = 'povestitorul-magic'; hover = 'povestitorul-magic'"
                     ...
                     <h3
                         ...
                         Povestitorul Magic</h3>
                     <p class="mt-2 text-sm text-gray-600">Platformă AI pentru povești interactive</p>
                     <div
                 ...
                 <!-- Truland -->
                 <div @click="selectedItem = 'truland'" @mouseenter="hoverItem = 'truland'; hover = 'truland'"
                     @mouseleave="hoverItem = null; hover = null"
                     class="relative p-6 transition-all duration-300 bg-white border-b-4 cursor-pointer group hover:shadow-xl rounded-xl border-emerald-500 hover:border-emerald-600">
                     <h3
                         class="text-xl font-semibold text-gray-800 transition-all duration-300 group-hover:text-emerald-600">
                 ...
                 <!-- Hover Image -->
                 <div x-show="hoverItem" :style="{ left: `${mouseX + 20}px`, top: `${mouseY - 200}px` }"
                     class="fixed z-50 hidden w-64 overflow-hidden transition-all duration-300 rounded-xl md:block">
                     <img :src="getImagePath(hoverItem)" :alt="hoverItem + ' preview'" class="w-full hover-image">
                 </div>
                 ...
                 <div x-cloak x-show="selectedItem !== null"
                     ...
                     <div class="p-6">
                         <button @click="selectedItem = null"
                             class="absolute text-emerald-500 top-4 right-4 hover:text-emerald-700">
                     ...
                     <div x-show="selectedItem === 'povestitorul-magic'">
                         <h2 class="mb-4 text-2xl font-bold">Povestitorul Magic</h2>
                         <img src="/assets/portofoliu/povestitorul-magic.webp" alt="Platforma Povestitorul Magic"
                             class="w-full rounded-lg">
                         <p class="mb-4">Povestitorul Magic este o platformă inovatoare care folosește inteligența
                             artificială pentru a crea povești personalizate cu ilustrații captivante pentru copii.
                             Această aplicație unică îmbină tehnologia modernă cu creativitatea pentru a oferi
                             experiențe de lectură interactive și memorabile.</p>
                         <ul class="mb-4 ml-6 list-disc">
                             <li>Dezvoltată în Laravel</li>
                             <li>Integrare Modele AI</li>
                             <li>Generare Povești Personalizate</li>
                             <li>Ilustrații Generate AI</li>
                             <li>Versiune Audio</li>
                             <li>Interfață Prietenoasă pentru Copii</li>
                             <li>Sistem de Personalizare Povești</li>
                         </ul>
                         <a href="https://povestitorulmagic.ro" target="_blank" rel="noopener noreferrer"
                     ...
                     <div x-show="selectedItem === 'click-music'">
                         ...
                         <img src="/assets/portofoliu/click-music.jpg" alt="Click Music Streaming App"
                             class="w-full rounded-lg">
                         <p class="mb-4">Clickmusic.ro este rezultatul eforturilor noastre constante de a crea
                             soluții
                             digitale de înaltă calitate, îmbunătățind experiența utilizatorilor în domeniul
                             streaming-ului muzical.</p>
                         <ul class="mb-4 ml-6 list-disc">
                         ...
                         <a href="https://clickmusic.ro" target="_blank" rel="noopener noreferrer"
                             class="inline-flex items-center px-4 py-2 mb-6 text-white transition-colors duration-300 rounded-lg bg-emerald-500 hover:bg-emerald-600">
                             Vizitează Site-ul
                             <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                     ...
                     <div x-show="selectedItem === 'instacapture'">
                         ...
                         <img src="/assets/portofoliu/instacapture.jpg"
                             alt="Aplicație de Fotografie Profesională InstaCapture" class="w-full rounded-lg">
                         <p class="mb-4">InstaCapture.ro este o aplicație web inovatoare dezvoltată de agenția
                             noastră pentru firma de fotografie profesională InstaCapture din Cluj-Napoca.</p>
                         <ul class="mb-4 ml-6 list-disc">
                             <li>Dezvoltată în Laravel</li>
                             <li>Panou de Control</li>
                     ...
                     <div x-show="selectedItem === 'snow-n-stuff'">
                         ...
                         <img src="/assets/portofoliu/snow-n-stuff.jpg" alt="Website Prezentare Snow 'n' Stuff"
                             class="w-full rounded-lg">
                         <p class="mb-4">Snow 'n' Stuff este un label muzical internațional de top, specializat în
                             genurile Tech House, Deep House, House și Techno.</p>
                         <ul class="mb-4 ml-6 list-disc">
                     ...
                     <div x-show="selectedItem === 'cs-victoria-mm'">
                         ...
                         <img src="/assets/portofoliu/csvictoriamm.jpg" alt="Branding Club Sportiv Victoria Maramureș"
                             class="w-full rounded-lg">
                         <p class="mb-4">Proiectul de branding pentru Clubul Sportiv Victoria Maramureș este o
                             călătorie fascinantă în definirea și exprimarea identității acestuia în mediul online și
                             offline.</p>
                         <ul class="mb-4 ml-6 list-disc">
                     ...
                     <div x-show="selectedItem === 'ioana-mihalca'">
                         ...
                         <img src="/assets/portofoliu/ioana-mihalca.jpg" alt="Site-ul Ioanei Mihalca"
                             class="w-full rounded-lg">
                         <p class="mb-4">Am creat un site de prezentare și blog pentru Ioana Mihalca, jurnalistă și
                             moderatoare de emisiuni și evenimente.</p>
                         <ul class="mb-4 ml-6 list-disc">
                     ...
                     <div x-show="selectedItem === 'truland'">
                         ...
                         <img src="/assets/portofoliu/truland.jpg" alt="Truland Magazin Online"
                             class="w-full rounded-lg">
                         <p class="mb-4">Truland este un magazin online specializat în încălțăminte de calitate,
                             oferind o gamă variată de pantofi, mocasini, ghete și sandale pentru femei.</p>
                         <ul class="mb-4 ml-6 list-disc">
     ...
     <div id="multimedia"
         class="flex items-center justify-center min-h-screen bg-gradient-to-t from-gray-500 to-white">
         <div class="container max-w-5xl px-2 mx-auto">
             <h2 class="my-12 text-xl font-bold text-center text-black uppercase font-roboto-condensed md:text-3xl">
                 Multimedia
             </h2>
             <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                 ...
                 <div x-data="{ open: false }"
                     ...
                     <div class="relative group" :class="{ 'group-hover': open }">
                     ...
                     <div class="p-6">
                         <button @click="open = !open"
                             ...
                             <svg :class="{ 'rotate-180': open }"
                                 class="w-5 h-5 transition-transform duration-300 transform text-emerald-500"
                         ...
                         <div x-show="open" x-transition:enter="transition ease-out duration-300"
                             ...
                             <p class="mb-4 leading-relaxed text-gray-700">
                                 "Podcast Morosenesc cu Ioana Mihalca" este un proiect de succes dedicat explorării
                                 povestirilor autentice și discuțiilor captivante. Acest podcast aduce în fața
                                 ascultătorilor povești de viață inspiraționale și conversații profunde cu personalități
                                 remarcabile din diverse domenii.
                             </p>
                             <ul class="mb-4 ml-6 list-disc">
                             ...
                             <a href="https://www.youtube.com/@IoanaMihalca" target="_blank"
                                 ...
                                 class="inline-flex items-center px-4 py-2 text-white transition-colors duration-300 rounded-lg bg-emerald-500 hover:bg-emerald-600">
                 ...
                 <div x-data="{ open: false }"
                     ...
                     <div class="p-6">
                         ...
                         <div x-show="open" x-transition:enter="transition ease-out duration-300"
                             ...
                             x-transition:leave-end="opacity-0 transform scale-95" class="mt-4">
                             <p class="mb-4 leading-relaxed text-gray-700">
                                 Click Music Romania reprezintă o parte importantă a activității noastre în domeniul
                                 producției muzicale și al conținutului video. Prin acest canal YouTube, ne-am propus să
                                 creăm conținut de calitate pentru iubitorii de muzică.
                             </p>
                             <p class="mb-4 leading-relaxed text-gray-700">
                                 De-a lungul timpului, am avut plăcerea să vedem cum comunitatea noastră a crescut,
                                 ajungând la peste 50 de milioane de vizualizări. Această cifră reflectă interesul
                                 publicului pentru conținutul nostru și ne motivează să continuăm să îmbunătățim
                                 calitatea producțiilor noastre.
                             </p>
