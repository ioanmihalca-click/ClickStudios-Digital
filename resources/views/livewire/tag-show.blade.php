...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-4">Postări cu eticheta: {{ $tag->nume }}</h1>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach ($post->tags as $tag)
                                <a href="{{ route('etichete.show', $tag->slug) }}" class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $tag->nume }}</a>
                            @endforeach
                        </div>
                    </div>
                </div>
