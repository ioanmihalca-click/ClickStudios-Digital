<div class="relative w-full h-full overflow-hidden font-roboto-condensed">
    ...
    <div class="relative z-10 flex flex-col justify-between h-full px-4 pt-20 pb-2 mx-auto max-w-5xl md:pt-24">
        <!-- Hero Section -->
        <section class="flex flex-col items-start justify-center grow-0 mt-2 md:mt-4">
            <h1 class="mb-2 uppercase tracking-tight leading-none">
                <span class="block mb-1 text-xl font-extrabold text-emerald-600 md:text-3xl lg:text-4xl">
                    Click Studios Digital:
                </span>
                <span class="block text-2xl font-black text-gray-900 md:text-5xl lg:text-6xl leading-tight">
                    Transformăm Ideile în <br /> Experiențe Digitale
                </span>
            </h1>

            <p class="max-w-lg mb-4 text-sm text-gray-600 md:text-base leading-snug">
                Dezvoltăm aplicații personalizate, cu expertiză în Laravel și integrări avansate
